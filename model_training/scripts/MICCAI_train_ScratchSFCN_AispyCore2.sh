...
SCRATCH_DIR="MICCAI_ScratchSFCN_mRS" # !!!!!!!!!!!!!!!!!!!
SOURCE_DIR="model_training/Data/SOOP/SOOP-T1w-LesionAligned"
...
BASE_TRAINING_OUTPUT_DIR="$SCRATCH_DIR/MICCAI_ScratchSFCN_mRS" # !!!!!!!!!!!!!!!!!!!
RUN_STORAGE_DIR="model_training/runs"
MODEL_CONFIG_FILE="model_training/scripts/aispy_config_MICCAI.yaml"
SEEDS_FILE="model_training/scripts/seeds_ALL.txt"

# Create matching structure in final storage
FINAL_OUTPUT_DIR="${RUN_STORAGE_DIR}/MICCAI_ScratchSFCN_mRS" # !!!!!!!!!!!!!!!!!!!
